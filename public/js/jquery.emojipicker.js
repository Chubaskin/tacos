;(function($) {
  ...
  var categories = [
    ...
    { name: 'naturaleza', label: 'Naturaleza' },
    { name: 'comida', label: 'Comida' },
    { name: 'actividades', label: 'Activitidades' },
    { name: 'viaje', label: 'Viajes y Lugares' },
    { name: 'objetos', label: 'Objectos' },
    { name: 'simbolo', label: 'Símbolos' },
    { name: 'bandera', label: 'Banderas' }
  ];
  ...
  $.extend(EmojiPicker.prototype, {
    ...
    addPickerIcon: function() {
      ...
      if (this.settings.button) {
        ...
        var objetosWidth = this.$el.width();

        this.$el.width(objetosWidth);
    ...
    updatePosition: function() {
      ...
      */
      ...
      var parentOffset = positionedParent.offset(); // now have a top/left objetos
    ...
    emojiTabMouseover: function(e) {
      ...
      if (categoryTitle == '') { categoryTitle = 'Usado Recientemente'; }
  ...
  function getPickerHTML() {
    ...
    if (localStorageSupport) {
      ...
      nodes.push('<h1>Usado Recientemente</h1><div class="wrap">');
  ...
  function generateEmojiOfDay() {
    ...
    var emoji = emojis[i];
    return 'TasOne: <span class="eod"><span class="emoji emoji-' + emoji.name + '"></span> <span class="emojiName">' + emoji.name + '</span></span>';
  }
  ...
  function addToLocalStorage(emoji) {
    ...
    // If already in Usado Recientemente, move to front
